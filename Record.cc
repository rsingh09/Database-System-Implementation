...
int Record :: ComposeRecord (Schema *mySchema, const char *src) {
	...
	if (space == NULL)
	{
		cout << "ERROR6 : Not enough memory. EXIT !!!\n";
		exit(1);
	}
	...
	if (recSpace == NULL)
	{
		cout << "ERROR7 : Not enough memory. EXIT !!!\n";
		exit(1);
	}
	...
	if (bits == NULL)
	{
		cout << "ERROR8 : Not enough memory. EXIT !!!\n";
		exit(1);
	}
...
int Record :: SuckNextRecord (Schema *mySchema, FILE *textFile) {
	...
	if (space == NULL)
	{
		cout << "ERROR9 : Not enough memory. EXIT !!!\n";
		exit(1);
	}
	...
	if (recSpace == NULL)
	{
		cout << "ERROR10 : Not enough memory. EXIT !!!\n";
		exit(1);
	}
...
void Record :: Print (Schema *mySchema, std::stringstream &s) {
